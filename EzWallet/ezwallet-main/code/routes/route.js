...
router.post("/users/:username/transactions", createTransaction) // v
router.get("/users/:username/transactions", getTransactionsByUser) // v
router.delete("/users/:username/transactions", deleteTransaction) // v
router.get("/users/:username/transactions/category/:category", getTransactionsByUserByCategory) // v
router.post("/groups", createGroup) 
router.get("/groups/:name", getGroup)
router.get("/groups/:name/transactions", getTransactionsByGroup) //saro
router.get("/groups/:name/transactions/category/:category", getTransactionsByGroupByCategory) //fede
...
router.get("/transactions/groups/:name/category/:category", getTransactionsByGroupByCategory) //TODO da qui in poi
